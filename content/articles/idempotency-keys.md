...
{{Figure "Rocket Rides the app." (ImgSrcAndAltAndClass "/content/images/idempotency-keys/rocketrides-ios-ride.png" "Rocket Rides the app." "overflowing")}}
...
{{Figure "A typical API request to our embellished Rocket Rides backend." (ImgSrcAndAltAndClass "/content/images/idempotency-keys/api-request.svg" "A typical API request to our embellished Rocket Rides backend." "overflowing")}}
...
{{Figure "API request to Rocket Rides broken into foreign state mutations and atomic phases." (ImgSrcAndAltAndClass "/content/images/idempotency-keys/atomic-phases.svg" "API request to Rocket Rides broken into foreign state mutations and atomic phases." "overflowing")}}
