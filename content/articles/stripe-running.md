...
{{Figure "The daunting Triple Peaks run in San Francisco." (ImgSrcAndAltAndClass "/content/images/stripe-running/triple-peaks.png" "The daunting Triple Peaks run in San Francisco." "overflowing")}}
