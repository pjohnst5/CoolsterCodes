...
{{Figure "A simplified view of Postgres' forking process model." (ImgSrcAndAltAndClass "/content/images/postgres-connections/process-model.svg" "A simplified view of Postgres' forking process model." "overflowing")}}
...
{{Figure "Performance of a simple task degrading as the number of active connections in the database increases." (ImgSrcAndAltAndClass "/content/images/postgres-connections/contention.png" "Performance of a simple task degrading as the number of active connections in the database increases." "overflowing")}}
...
{{Figure "Using PgBouncer to maintain a global connection pool to optimize connection use across all nodes." (ImgSrcAndAltAndClass "/content/images/postgres-connections/pgbouncer.svg" "Using PgBouncer to maintain a global connection pool to optimize connection use across all nodes." "overflowing")}}
