...
{{Figure "Errors subsiding after a transition to Redis Cluster." (ImgSrcAndAltAndClass "/content/images/redis-cluster/errors.png" "Errors subsiding after a transition to Redis Cluster." "overflowing")}}
...
{{Figure "The set of hash slots spread across nodes in a cluster." (ImgSrcAndAltAndClass "/content/images/redis-cluster/hash-slots.svg" "The set of hash slots spread across nodes in a cluster." "overflowing")}}
...
{{Figure "A slot migrating from one node to another." (ImgSrcAndAltAndClass "/content/images/redis-cluster/moved-redirection.svg" "A slot migrating from one node to another." "overflowing")}}
...
{{Figure "Your daily dose of tangentially related photography: Stone at the top of Massive Mountain in Alberta sharding into thin flakes." (ImgSrcAndAltAndClass "/content/images/redis-cluster/sharding.jpg" "Your daily dose of tangentially related photography: Stone at the top of Massive Mountain in Alberta sharding into thin flakes." "overflowing")}}
