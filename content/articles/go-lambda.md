...
{{Figure "Prompt for creating a new function on Lambda." (ImgSrcAndAltAndClass "/contents/images/go-lambda/create-function.png" "Prompt for creating a new function on Lambda." "overflowing")}}
...
{{Figure "Go 1.x's longevity is so impressive that it feels like a part of the landscape." (ImgSrcAndAltAndClass "/contents/images/go-lambda/mountain.jpg" "Go 1.x's longevity is so impressive that it feels like a part of the landscape." "overflowing")}}
