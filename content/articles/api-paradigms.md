...
{{Figure "GraphQL produces an API that can be queried in complex ways." (ImgSrcAndAltAndClass "/contents/images/api-paradigms/graphql.jpg" "GraphQL produces an API that can be queried in complex ways." "overflowing")}}
...
{{Figure "By dropping a resource-based world view, we can better map endpoints to the user actions." (ImgSrcAndAltAndClass "/contents/images/api-paradigms/rpc-vs-rest.svg" "By dropping a resource-based world view, we can better map endpoints to the user actions." "overflowing")}}
...
{{Figure "Some tooling to help create a bespoke leather product." (ImgSrcAndAltAndClass "/contents/images/api-paradigms/bespoke.jpg" "Some tooling to help create a bespoke leather product." "overflowing")}}
