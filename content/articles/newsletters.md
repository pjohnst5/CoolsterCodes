...
{{Figure "The first issue of Passages & Glass successfully rendering in Google Mail (after considerable pain)." (ImgSrcAndAltAndClass "/content/images/newsletters/passages-001.png" "The first issue of Passages & Glass successfully rendering in Google Mail (after considerable pain)." "overflowing")}}
...
{{Figure `My newsletter is called "Passages & Glass." Here's a photo from the Chihuly Garden and Glass museum in Seattle.` (ImgSrcAndAltAndClass "/content/images/newsletters/chihuly-glass.jpg" `My newsletter is called "Passages & Glass." Here's a photo from the Chihuly Garden and Glass museum in Seattle.` "overflowing")}}
