...
{{Figure "A visualization of the \"leaky bucket\" analog, where water is symbolic of rate-limited actions." (ImgSrcAndAltAndClass "/content/images/rate-limiting/leaky-bucket.svg" "A visualization of the \"leaky bucket\" analog, where water is symbolic of rate-limited actions." "overflowing")}}
...
{{Figure "A visualization of an allowed request under GCRA. A request at time t0 is successful." (ImgSrcAndAltAndClass "/content/images/rate-limiting/allowed-request.svg" "A visualization of an allowed request under GCRA. A request at time t0 is successful." "overflowing")}}

For a failed request, the time of the next allowed request is in the future,
prompting us to deny the request:

{{Figure "A visualization of a denied request under GCRA. A request at time t0 is rejected." (ImgSrcAndAltAndClass "/content/images/rate-limiting/denied-request.svg" "A visualization of a denied request under GCRA. A request at time t0 is rejected." "overflowing")}}
