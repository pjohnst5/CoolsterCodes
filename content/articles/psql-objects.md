...
{{Figure "A database cluster: tables nested within a schema, nested within a database." (ImgSrcAndAltAndClass "/content/images/psql-objects/cluster.svg" "A database cluster: tables nested within a schema, nested within a database." "overflowing")}}
