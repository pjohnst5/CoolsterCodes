import { a as W, d as D } from "./chunk-OSRY5VT3.min.js";
var ee = W((Z, Y) => {
  (function () {
    var t = function (e) {
      var r = new t.Builder;
    ...
    t.tokenizer = function (e, r) {
      ...
      if (Array.isArray(e))
        return e.map(function (d) {
          return new t.Token(t.utils.asString(d).toLowerCase(), t.utils.clone(r))
        });
      for (var n = e.toString().toLowerCase(), i = n.length, s = [], o = 0, u = 0; o <= i; o++) {
        var l = n.charAt(o)
          , a = o - u;
...
`, e)
    ...
    t.Vector = function (e) {
      ...
      t.Vector.prototype.dot = function (e) {
        for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, u = 0, l = 0, a = 0, f = 0; a < s && f < o;)
          u = n[a],
            l = i[f],
            u < l ? a += 2 : u > l ? f += 2 : u == l && (r += n[a + 1] * i[f + 1],
              a += 2,
              f += 2);
        return r
      }
      ...
      var e = {
        ...
        , K = function (c) {
          ...
          if (k = c.substr(0, 1),
            ...
            y = m,
            Q = _,
            y.test(c) ? c = c.replace(y, "$1$2") : Q.test(c) && (c = c.replace(Q, "$1$2")),
            y = v,
            Q = S,
            y.test(c)) {
            var b = y.exec(c);
            ...
            O = b[1],
              ...
              Q.test(O) && (c = O,
                ...
                A = I,
                M = B,
                Q.test(c) ? c = c + "e" : A.test(c) ? (y = x,
                  c = c.replace(y, "")) : M.test(c) && (c = c + "e"))
          }
          if (y = P,
            y.test(c)) {
            var b = y.exec(c);
    ...
    t.TokenSet = function () {
      ...
      t.TokenSet.fromFuzzyString = function (e, r) {
        for (var n = new t.TokenSet, i = [{
          ...
          var s = i.pop();
          if (s.str.length > 0) {
            var o = s.str.charAt(0), u;
            o in s.node.edges ? u = s.node.edges[o] : (u = new t.TokenSet,
              s.node.edges[o] = u),
          ...
          if (s.editsRemaining != 0) {
            ...
            if (s.str.length > 1) {
              var f = s.str.charAt(0), d = s.str.charAt(1), h;
              d in s.node.edges ? h = s.node.edges[d] : (h = new t.TokenSet,
                s.node.edges[d] = h),
      ...
      t.TokenSet.prototype.intersect = function (e) {
        for (var r = new t.TokenSet, n = void 0, i = [{
          ...
          n = i.pop();
          for (var s = Object.keys(n.qNode.edges), o = s.length, u = Object.keys(n.node.edges), l = u.length, a = 0; a < o; a++)
            for (var f = s[a], d = 0; d < l; d++) {
              ...
              if (h == f || f == "*") {
                var g = n.node.edges[h]
                  ...
                  , m = g.final && p.final
                  , _ = void 0;
                h in n.output.edges ? (_ = n.output.edges[h],
                  _.final = _.final || m) : (_ = new t.TokenSet,
                    _.final = m,
                    n.output.edges[h] = _),
                  i.push({
                    qNode: p,
    ...
    t.Index = function (e) {
      ...
      t.Index.prototype.query = function (e) {
        for (var r = new t.Query(this.fields), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), u = Object.create(null), l = 0; l < this.fields.length; l++)
        ...
        for (var l = 0; l < r.clauses.length; l++) {
          var a = r.clauses[l]
            , f = null
            , d = t.Set.empty;
          a.usePipeline ? f = this.pipeline.runString(a.term, {
            fields: a.fields
          }) : f = [a.term];
          for (var h = 0; h < f.length; h++) {
            ...
            for (var S = 0; S < m.length; S++)
              for (var x = m[S], H = this.invertedIndex[x], I = H._index, _ = 0; _ < a.fields.length; _++) {
                var v = a.fields[_]
                  , B = H[v]
                  , P = Object.keys(B)
                  , T = x + "/" + v
                  , L = new t.Set(P);
                if (a.presence == t.Query.presence.REQUIRED && (d = d.union(L),
                ...
                if (i[v].upsert(I, a.boost, function (ye, _e) {
                  return ye + _e
                }),
                  !s[T]) {
                  for (var F = 0; F < P.length; F++) {
                    var N = P[F], C = new t.FieldRef(N, v), j = B[N], U;
                    (U = n[C]) === void 0 ? n[C] = new t.MatchData(x, v, j) : U.add(x, v, j)
                  }
                  s[T] = !0
                }
              }
        ...
        for (var K = t.Set.complete, R = t.Set.empty, l = 0; l < this.fields.length; l++) {
          var v = this.fields[l];
          o[v] && (K = K.intersect(o[v])),
            u[v] && (R = R.union(u[v]))
        }
        var c = Object.keys(n)
          , O = []
        ...
        for (var l = 0; l < c.length; l++) {
          ...
          if (K.contains(y) && !R.contains(y)) {
            var Q = this.fieldVectors[k], A = i[k.fieldName].similarity(Q), M;
            if ((M = E[y]) !== void 0)
              M.score += A,
                M.matchData.combine(n[k]);
            else {
              var b = {
                ref: y,
                score: A,
    ...
    t.Builder = function () {
        ...
        for (var s = 0; s < i.length; s++) {
          ...
          for (var g = 0; g < f.length; g++) {
            ...
            if (h[p] == null && (h[p] = 0),
              ...
              m._index = this.termIndex,
                this.termIndex += 1;
              for (var _ = 0; _ < i.length; _++)
                m[i[_]] = Object.create(null);
              this.invertedIndex[p] = m
            }
            this.invertedIndex[p][o][n] == null && (this.invertedIndex[p][o][n] = Object.create(null));
            for (var v = 0; v < this.metadataWhitelist.length; v++) {
              var S = this.metadataWhitelist[v]
                , x = p.metadata[S];
              this.invertedIndex[p][o][n][S] == null && (this.invertedIndex[p][o][n][S] = []),
      ...
      t.Builder.prototype.createFieldVectors = function () {
        for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
          for (var o = t.FieldRef.fromString(r[s]), u = o.fieldName, l = this.fieldLengths[o], a = new t.Vector, f = this.fieldTermFrequencies[o], d = Object.keys(f), h = d.length, g = this._fields[u].boost || 1, p = this._documents[o.docRef].boost || 1, m = 0; m < h; m++) {
            var _ = d[m], v = f[_], S = this.invertedIndex[_]._index, x, H, I;
            i[_] === void 0 ? (x = t.idf(this.invertedIndex[_], this.documentCount),
              i[_] = x) : x = i[_],
              H = x * ((this._k1 + 1) * v) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[u])) + v),
              H *= g,
              H *= p,
      ...
      t.MatchData.prototype.combine = function (e) {
        for (var r = Object.keys(e.metadata), n = 0; n < r.length; n++) {
          ...
          for (var o = 0; o < s.length; o++) {
            ...
            this.metadata[i][u] == null && (this.metadata[i][u] = Object.create(null));
            for (var a = 0; a < l.length; a++) {
              var f = l[a];
              this.metadata[i][u][f] == null ? this.metadata[i][u][f] = e.metadata[i][u][f] : this.metadata[i][u][f] = this.metadata[i][u][f].concat(e.metadata[i][u][f])
            }
          }
        }
      }
      ...
      ,
      function (e, r) {
        typeof define == "function" && define.amd ? define(r) : typeof Z == "object" ? Y.exports = r() : e.lunr = r()
      }(this, function () {
        return t
      })
  }
...
var re = W((V, te) => {
  (function (t, e) {
    typeof define == "function" && define.amd ? define(e) : typeof V == "object" ? te.exports = e() : e()(t.lunr)
  }
  )(V, function () {
    return function (t) {
      t.stemmerSupport = {
        Among: function (e, r, n, i) {
          if (this.toCharArray = function (s) {
            ...
            ,
            !e && e != "" || !r && r != 0 || !n)
            throw "Bad Among initialisation: s:" + e + ", substring_i: " + r + ", result: " + n;
        ...
        SnowballProgram: function () {
          ...
          return {
            ...
            eq_s: function (r, n) {
              if (this.limit - this.cursor < r)
                return !1;
              for (var i = 0; i < r; i++)
                if (e.charCodeAt(this.cursor + i) != n.charCodeAt(i))
                  return !1;
              return this.cursor += r,
                !0
            },
            eq_s_b: function (r, n) {
              if (this.cursor - this.limit_backward < r)
                return !1;
              for (var i = 0; i < r; i++)
            ...
            find_among: function (r, n) {
              for (var i = 0, s = n, o = this.cursor, u = this.limit, l = 0, a = 0, f = !1; ;) {
                for (var d = i + (s - i >> 1), h = 0, g = l < a ? l : a, p = r[d], m = g; m < p.s_size; m++) {
                  if (o + g == u) {
                    h = -1;
                    break
                  }
                  if (h = e.charCodeAt(o + g) - p.s[m],
                    h)
                    break;
                  g++
                }
            ...
            find_among_b: function (r, n) {
              for (var i = 0, s = n, o = this.cursor, u = this.limit_backward, l = 0, a = 0, f = !1; ;) {
                for (var d = i + (s - i >> 1), h = 0, g = l < a ? l : a, p = r[d], m = p.s_size - 1 - g; m >= 0; m--) {
                  if (o - g == u) {
                    h = -1;
                    break
                  }
                  if (h = e.charCodeAt(o - 1 - g) - p.s[m],
                    h)
                    break;
                  g++
                }
            ...
            replace_s: function (r, n, i) {
              ...
              return e = o + i + u,
                this.limit += s,
                this.cursor >= n ? this.cursor += s : this.cursor > r && (this.cursor = r),
                s
            },
            slice_check: function () {
              if (this.bra < 0 || this.bra > this.ket || this.ket > this.limit || this.limit > e.length)
            ...
            slice_to: function () {
              return this.slice_check(),
                e.substring(this.bra, this.ket)
            },
            eq_v_b: function (r) {
        ...
        t.trimmerSupport = {
          generateTrimmer: function (e) {
            var r = new RegExp("^[^" + e + "]+")
              , n = new RegExp("[^" + e + "]+$");
            return function (i) {
              return typeof i.update == "function" ? i.update(function (s) {
...
var ne = W((z, ie) => {
  (function (t, e) {
    typeof define == "function" && define.amd ? define(e) : typeof z == "object" ? ie.exports = e() : e()(t.lunr)
  }
  )(z, function () {
    return function (t) {
      function e() {
      ...
      e.prototype.ctype_ = function (r) {
        for (var n in this.chartype_)
          if (r.match(this.chartype_[n][0]))
            return this.chartype_[n][1];
        return "O"
      }
        ,
        ...
        e.prototype.segment = function (r) {
          ...
          i.push("E1"),
            ...
            s.push("O"),
            s.push("O");
          for (var u = i[3], l = "U", a = "U", f = "U", d = 4; d < i.length - 3; ++d) {
            var h = this.BIAS__
              , g = i[d - 3]
              , p = i[d - 2]
              , m = i[d - 1]
...
var oe = W(($, se) => {
  (function (t, e) {
    typeof define == "function" && define.amd ? define(e) : typeof $ == "object" ? se.exports = e() : e()(t.lunr)
  }
  )($, function () {
    return function (t) {
      t.multiLanguage = function () {
        for (var e = Array.prototype.slice.call(arguments), r = e.join("-"), n = "", i = [], s = [], o = 0; o < e.length; ++o)
          e[o] == "en" ? (n += "\\w",
            i.unshift(t.stopWordFilter),
            i.push(t.stemmer),
            s.push(t.stemmer)) : (n += t[e[o]].wordCharacters,
              t[e[o]].stopWordFilter && i.unshift(t[e[o]].stopWordFilter),
              t[e[o]].stemmer && (i.push(t[e[o]].stemmer),
                s.push(t[e[o]].stemmer)));
        var u = t.trimmerSupport.generateTrimmer(n);
        return t.Pipeline.registerFunction(u, "lunr-multi-trimmer-" + r),
          i.unshift(u),
          function () {
            this.pipeline.reset(),
...
var q;
function ue() {
  return q || (q = X("keyval-store", "keyval")),
    q
}
function ae(t, e = ue()) {
...
function he(t, e, r = ue()) {
  return r("readwrite", n => (n.put(e, t),
    J(n.transaction)))
}
var G;
async function ve({ lunrLanguages: t }) {
  ...
  async function n() {
    let i = await fetch("index.json")
      ...
      , u = X("docfx", "lunr");
    if (t && t.length > 0 && ((0,
      ce.default)(w.default),
      (0,
        le.default)(w.default),
      t.includes("ja") && (0,
        fe.default)(w.default),
      await Promise.all(t.map(me))),
      s) {
      let a = JSON.parse(await ae("index", u) || "{}");
      if (a && a.etag === s)
        return {
          index: w.default.Index.load(a),
          data: o
        }
    }
    let l = (0,
    ...
    return s && await he("index", JSON.stringify(Object.assign(l.toJSON(), {
      etag: s
    })), u),
    {
      index: l,
...
onmessage = function (t) {
  ...
  ;
var ge = {
  ar: () => import("./lunr.ar-A6ZT2INA.min.js"),
  da: () => import("./lunr.da-WWM276CR.min.js"),
  de: () => import("./lunr.de-XXPRKDAY.min.js"),
  du: () => import("./lunr.du-NO4L2LL3.min.js"),
  el: () => import("./lunr.el-5ZSSJVMA.min.js"),
  es: () => import("./lunr.es-ZH6Q76E6.min.js"),
  fi: () => import("./lunr.fi-S7WJSBCP.min.js"),
  fr: () => import("./lunr.fr-H2QNBELV.min.js"),
  he: () => import("./lunr.he-TTLAK4MN.min.js"),
  hi: () => import("./lunr.hi-PWWMAGLU.min.js"),
  hu: () => import("./lunr.hu-DLG2DSVM.min.js"),
  hy: () => import("./lunr.hy-FFQJAR7M.min.js"),
  it: () => import("./lunr.it-VQNLJLPR.min.js"),
  ja: () => import("./lunr.ja-J6QHZSR2.min.js"),
  jp: () => import("./lunr.jp-M45D3XJE.min.js"),
  kn: () => import("./lunr.kn-ASLXFRTC.min.js"),
  ko: () => import("./lunr.ko-RHF2BDE4.min.js"),
  nl: () => import("./lunr.nl-2BITG354.min.js"),
  no: () => import("./lunr.no-WPLSHWFO.min.js"),
  pt: () => import("./lunr.pt-V2XEBELC.min.js"),
  ro: () => import("./lunr.ro-O76266FJ.min.js"),
  ru: () => import("./lunr.ru-G56UDXYH.min.js"),
  sa: () => import("./lunr.sa-LD5PRAIS.min.js"),
  sv: () => import("./lunr.sv-7VRY4UDB.min.js"),
  ta: () => import("./lunr.ta-OWB7AURB.min.js"),
  te: () => import("./lunr.te-JGGL3BFP.min.js"),
  th: () => import("./lunr.th-O4JBL3IY.min.js"),
  tr: () => import("./lunr.tr-WXUV733C.min.js"),
  vi: () => import("./lunr.vi-3U4A337N.min.js")
};
async function me(t) {
  if (t !== "en") {
