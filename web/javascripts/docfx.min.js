    ...
    <div class='dropdown'>
      ...
      <ul class='dropdown-menu dropdown-menu-end'>
        ...
        <div class="sr-items">${a.map(B=>{let Z=window.location.href,W=o(Z,t+B.href),x=t+B.href,Q=B.summary?l(B.summary):"";return u`
            <div class="sr-item">
              <div class="item-title"><a href="${x}" target="_blank" rel="noopener noreferrer">${Vb(B.title,Ft)}</a></div>
